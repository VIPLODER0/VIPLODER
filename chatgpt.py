...
load_dotenv()
BOT_TOKEN = os.getenv("8018753837:AAEOtjfr3-mZw8PTH02p77gSEg1Rtk7Kosc")  # .env फाइल में रखें: BOT_TOKEN=your_token_here
...
def GOJO(user_input):
    ...
    try:
        ...
        response.raise_for_status()  # 4xx/5xx त्रुटियों के लिए जांच
...
def handle_message(message):
    ...
    try:
        # अगर "That's enough" जरूरी नहीं, तो हटा दें
